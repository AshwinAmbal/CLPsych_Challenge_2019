...
taskB_path ="C:\\CLPsych Challenge\\Dataset\\clpsych19_training_data\\task_B_train.posts.csv"
...
with open("C:\\CLPsych Challenge\\Dataset\\PreProcessing\\Task B-BERT_FINE_TUNING\\OverSampled-Train-Test-Data\\Full_Train_Data.tsv",'w', encoding = 'utf8', newline='') as outcsv:
