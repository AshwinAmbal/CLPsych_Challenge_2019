...
path ="C:\\CLPsych Challenge\\Dataset\\clpsych19_training_data\\task_B_train.posts.csv"
file = open(path, 'r', encoding = 'utf8')
reader_data = csv.reader(file, delimiter=',')
...
path ="C:\\CLPsych Challenge\\Dataset\\clpsych19_training_data\\trainUserIds_TaskB_Final.csv"
