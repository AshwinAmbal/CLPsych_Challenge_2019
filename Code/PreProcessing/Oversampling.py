...
with open("C:\\CLPsych Challenge\\Dataset\\PreProcessing\\Task C-BERT_FINE_TUNING\\OverSampled-Train-Test-Data\\Full_Train_Data.tsv",'r', encoding = 'utf8', newline='') as outcsv:   
...
with open("C:\\CLPsych Challenge\\Dataset\\PreProcessing\\Task C-BERT_FINE_TUNING\\OverSampled-Train-Test-Data\\Full_Train_Data_Final.tsv",'w', encoding = 'utf8', newline='') as outcsv:   
