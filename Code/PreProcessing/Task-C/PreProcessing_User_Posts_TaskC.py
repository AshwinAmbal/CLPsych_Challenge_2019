...
path ="C:\\CLPsych Challenge\\Dataset\\clpsych19_training_data\\combined_data_Task_C.csv"
all_data = dict()
...
taskB_path ="C:\\CLPsych Challenge\\Dataset\\clpsych19_training_data\\task_C_train.posts.csv"
...
with open("C:\\CLPsych Challenge\\Dataset\\PreProcessing\\Task C-BERT_FINE_TUNING\\OverSampled-Train-Test-Data\\Full_Train_Data.tsv",'w', encoding = 'utf8', newline='') as outcsv:
